...
public class CustomerDirectoryService implements CustomerDirectory {
    ...
    //tests
    public Customer createTest(Customer customer) {

        if ((validateNifNoRepeatedCreate(customer.getNif()) == true) && (validateEmailNoRepeatedCreate(customer.getEmail()) == true)) {
            customerDirectory.add(customer);
            System.out.println(customer.toString());
        }
    ...
    public void deleteTest(Customer customer) {
    ...
    public void updateTest(Customer customer) {
        ...
        do {
            ...
            if (!customerFound) {
                ...
                if (newNIF.equalsIgnoreCase(updatedCustomer.getNif()) || validateNifNoRepeatedUpdate(newNIF)) {

                    updatedCustomer.setNif(newNIF);
                    String newEmail = menu.email();

                    if (newEmail.equalsIgnoreCase(updatedCustomer.getEmail()) || validateEmailNoRepeatedUpdate(newEmail)) {
    ...
    public ArrayList<Customer> findByNIFTest() {
    ...
    public ArrayList<Customer> findByEmailTest() {
    ...
    public ArrayList<Customer> findByNameTest() {
    ...
    public ArrayList<Customer> findBySurnameTest() {
    ...
    public ArrayList<Customer> findByCityTest() {
    ...
    public ArrayList<Customer> findByCountryTest() {
    ...
    public String listAllDeletedTest() {
    ...
    public boolean validateNifNoRepeatedCreate(String nif) {
        boolean valid = true;
        boolean exists = false;
        String originalNif = "";
        boolean original = false;
    ...
    public boolean validateEmailNoRepeatedCreate(String email) {
        boolean valid = true;
        boolean exists = false;
        String originalEmail = "";
        boolean original = false;
    ...
    public boolean validateNifNoRepeatedUpdate(String nif) {
        boolean valid = true;
        boolean exists = false;
        String originalNif = "";
        boolean original = false;
    ...
    public boolean validateEmailNoRepeatedUpdate(String email) {
        boolean valid = true;
        boolean exists = false;
        String originalEmail = "";
        boolean original = false;
